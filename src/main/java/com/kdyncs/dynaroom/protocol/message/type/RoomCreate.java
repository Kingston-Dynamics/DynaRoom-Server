 ...
 * @author peter
 */
public class RoomCreate extends Message {
    
    private static final MessageType type = MessageType.ROOM_CREATE;
    
    public RoomCreate(String auditId) {
    ...
    public RoomCreate(Readinator reader) {
        super(reader);
    }
    
    public RoomCreate(byte[] data) {
    ...
    public byte[] build() {
        ...
        return Concatinator.concatinateByteArrays(super.build());
    }
}
